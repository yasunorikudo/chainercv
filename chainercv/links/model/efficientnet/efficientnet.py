...
class MBConvBlock(chainer.Chain):
    ...
    def __init__(self, kernel_size, num_repeat, input_filters, output_filters,
        ...
        with self.init_scope():
            ...
            setattr(self, bn_name, L.BatchNormalization(middle_filters, **bn_kwargs))
            ...
            setattr(self, bn_name, L.BatchNormalization(output_filters, **bn_kwargs))
...
class EfficientNet(PickableSequentialChain):
    ...
    def __init__(self, model_name='efficientnet-b0',
        ...
        param, path = utils.prepare_pretrained_model(
            {'n_class': n_class, 'mean': mean, 'scale': scale, 'bn_kwargs': bn_kwargs},
            pretrained_model, self._models[model_name],
            {'n_class': 1000, 'mean': _imagenet_mean, 'scale': _imagenet_scale, 'bn_kwargs': {}})
        ...
        with self.init_scope():
            ...
            for i, a in enumerate(block_args):
                setattr(self, 'block{}'.format(i + 1), MBConvs(a, efficientnet_params, bn_kwargs))
